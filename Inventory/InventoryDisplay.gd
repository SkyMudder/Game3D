...
onready var InventorySlotDisplay: PackedScene = load("res://Inventory/InventorySlotDisplay.tscn")
onready var inventory: Inventory = Inventories.playerInventory
var currentlySelected: int = 2
...
func getSlot(index: int, _inventoryChanged: int) -> Node:
